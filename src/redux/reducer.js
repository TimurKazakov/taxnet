import {ADDBOOKMARK, ADDTAG, CLEARFILTERTITLE, FILTERTITLE, REMOVEBOOKMARK, REMOVETAG,} from "./actions/actionTypes";
...
export default function reducer(state =initialState, action) {
    ...
    switch (action.type) {
        ...
        case ADDTAG:
            return {
                ...state,
                currentFilterTag: state.currentFilterTag.push(action.payload),

            };
        case REMOVETAG:
            return {
                ...state,
                currentFilterTag: state.currentFilterTag.splice(state.currentFilterTag.indexOf(action.payload),1),
